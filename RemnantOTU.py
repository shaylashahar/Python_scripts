...
otu = pd.read_csv("/Users/shayla/otu.csv")
#print(otu.head)
...
new_otu.to_csv("/Users/shayla/otu_bact_arch.csv")
### read in euks OTU, filter for fungi kingdom 
euks = pd.read_csv("/Users/shayla/Project/otu_euks.csv")
...
fung.to_csv("/Users/shayla/Project/otu_fungi.csv")

### match columns of bact/arch with fungi 
bactarch = pd.read_csv("/Users/shayla/Project/otu_bact_arch.csv")
bactarch = bactarch.drop(['Unnamed: 0', 'gene_id', 'domain'], axis=1)
print(bactarch.columns)
fungi = pd.read_csv("/Users/shayla/Project/otu_fungi.csv")
...
merged.to_csv("/Users/shayla/Project/otu_ToCount.csv")

### add counts for matching lineages 
merged = merged.groupby(['lineage', 'sample']).agg({"Count": "sum"})
merged.to_csv("/Users/shayla/Project/otu_final.csv")
